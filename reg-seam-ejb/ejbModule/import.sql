...
insert into osoba (id, flaga, haslo, imie, login, nazwisko, rola) values (3,TRUE, 'muc', 'Delfina','muc', 'Muc','S');
...
insert into osoba (id, flaga, haslo, imie, login, nazwisko, rola) values (18, TRUE, 'wykladowca','Pan','wykladowca', 'Wykladowca', 'W');
insert into osoba (id, flaga, login, imie, haslo, nazwisko, rola) values (16, TRUE, 'alina', 'Alina','alina', 'Swebocka', 'W');
insert into osoba (id, flaga, haslo, imie, login, nazwisko, rola) values (17, TRUE, 'ewa', 'Ewa', 'ewa', 'Cytawa', 'D');
