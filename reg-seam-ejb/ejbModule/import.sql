...
insert into osoba (id, haslo, imie, login, nazwisko, rola) values (3,'muc', 'Delfina','muc', 'Muc','S');
insert into osoba (id, haslo, imie, login, nazwisko, rola) values (4,'robak', 'Emeryk','robak', 'Robak','S');
insert into osoba (id, haslo, imie, login, nazwisko, rola) values (5,'gazda', 'Filipina', 'gazda', 'Gazda', 'S');
...
insert into osoba (id, haslo, imie, login, nazwisko, rola) values (18, 'wykladowca','Pan','wykladowca', 'Wykladowca', 'W');
insert into osoba (id, login, imie, haslo, nazwisko, rola) values (16, 'alina', 'Alina','alina', 'Swebocka', 'W');
